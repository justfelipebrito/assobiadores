  ...
  it('creates an audio daily highlight with category metadata', async () => {
    ...
    await expect(
      createDailyHighlightFromAudio(db as never, {
        ...
        sizeBytes: 1234,
        originalAudioURL: 'https://storage.example/audio-original.webm',
        originalAudioPath: 'daily-highlights/user-1/audio-original.webm',
        originalContentType: 'audio/webm',
        originalSizeBytes: 4321,
        durationSeconds: 42,
        category: 'melodia',
    ...
    expect(tx.set).toHaveBeenCalledWith(
      ...
      expect.objectContaining({
        ...
        mediaOriginalURL: 'https://storage.example/audio-original.webm',
        mediaOriginalPath: 'daily-highlights/user-1/audio-original.webm',
        mediaOriginalContentType: 'audio/webm',
        mediaOriginalSizeBytes: 4321,
