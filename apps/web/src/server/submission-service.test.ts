...
describe('createSubmission', () => {
  const audioInput = {
    ...
    sizeBytes: 2048,
    originalAudioURL: 'https://storage.example/battle-original.webm',
    originalAudioPath: 'battle-submissions/battle-1/user-1-original.webm',
  ...
  it('creates an active audio submission for a confirmed battle participant', async () => {
    ...
    expect(submissionRef.set).toHaveBeenCalledWith(
      expect.objectContaining({
        ...
        mediaOriginalURL: 'https://storage.example/battle-original.webm',
        mediaOriginalPath: 'battle-submissions/battle-1/user-1-original.webm',
        mediaOriginalContentType: 'audio/webm',
        mediaOriginalSizeBytes: 4096,
