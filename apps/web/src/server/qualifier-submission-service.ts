...
export async function createQualifierSubmission(
  ...
  return db.runTransaction(async (transaction) => {
    ...
    const submission = {
      ...
      scope: match.scope === 'national' ? 'national' : 'regional',
      region: typeof match.region === 'string' ? match.region : null,
      format: match.format === 'mini_knockout' ? 'mini_knockout' : 'state_qualifier',
      eventId: typeof match.eventId === 'string' ? match.eventId : null,
